...
export function ProgressNotesList({ notes }: { notes: ClinicalRecord["progress_notes"] }) {
  return (
    <RecordPanel title="Progress notes" description="What each shift wrote, newest first.">
      {notes.length === 0 ? (
        <RecordEmpty
          icon={NotebookPen}
